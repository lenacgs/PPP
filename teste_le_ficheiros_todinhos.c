...
void le_ficheiro_salas(Next_sala lista_salas, Next_exame lista_exames) {
  FILE *fp = fopen("ficheiro_salas.txt", "r");
  char id[100], *sala, string[100], s[2] = ",";
  int id_exame;
  Next_exame l_exames = lista_exames->next;
  Next_sala novaSala, l_salas = lista_salas;
...
int main() {
  ...
  le_ficheiro_salas(lista_salas, lista_exames);
  printf("acabou\n");
  return 0;
}
