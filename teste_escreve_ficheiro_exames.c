...
void escreve_ficheiro_exame(Next_exame lista_exames, Next_exame novoExame) {
  Next_ptrs_aluno l_inscritos;
  Next_exame l_exames = lista_exames;
  FILE *fp = fopen("ficheiro_exames_teste.txt", "a");
  char *string;
...
void cria_exame(Next_exame lista_exames, Next_aluno lista_alunos, Next_disciplina lista_disciplinas) {
  ...
  /*    scanf("%s", string);
      ...
      printf("Sai insere exame\n");
      escreve_ficheiro_exame(lista_exames, exame);
    }
}
